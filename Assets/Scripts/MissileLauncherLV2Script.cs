...
public class MissileLauncherLV2Script : MonoBehaviour
{
    ...
    public GameObject Bullet; // Referência ao objeto de míssil
    ...
    void shoot()
    {
        ...
        // Instancia dois mísseis e adiciona uma força para impulsioná-los na direção correta
